...
<div class="daily-tarot-container">
    ...
    <!-- Loading state -->
    <div class="daily-tarot-loading" style="display: none;">
        <div class="spinner"></div>
        <p><?php echo esc_html__('Loading today\'s card...', 'three-card-tarot'); ?></p>
    </div>
    
    <!-- Daily card content (will be populated by JavaScript) -->
    <div class="daily-tarot-card" style="display: none;">
        ...
        <div class="daily-card-info">
            <h3 class="daily-card-name">
                <!-- Card name will be inserted here -->
            </h3>
    ...
    <!-- Error state -->
    <div class="daily-tarot-error" style="display: none;">
